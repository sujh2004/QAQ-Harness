...
-- One human decision per session and skill. Executing a downloaded script is never implied by
-- installing it; the approval names the session it applies to and is recorded like any other fact.
